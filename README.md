...
- `GET /api/leaderboard?stat=<type>&limit=10`: Ranked list of players.
  - `stat` options: `caughtCount`, `shinyCaughtCount`, `pvpWins`, `battleWins`, `eggsHatched`, `tradedCount`, `evolvedCount`, `pokedexCaught`, `pokedexSeen`, `playtimeTicks`, `totalPokemon`.
