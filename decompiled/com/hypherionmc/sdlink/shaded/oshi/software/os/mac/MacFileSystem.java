 ...
 */
package com.hypherionmc.sdlink.shaded.oshi.software.os.mac;
...
import com.hypherionmc.sdlink.shaded.oshi.software.os.mac.MacOSFileStore;
import com.hypherionmc.sdlink.shaded.oshi.util.FileSystemUtil;
import com.hypherionmc.sdlink.shaded.oshi.util.platform.mac.CFUtil;
...
extends AbstractFileSystem {
    ...
    public static final String OSHI_MAC_FS_PATH_EXCLUDES = "com.hypherionmc.sdlink.shaded.oshi.os.mac.filesystem.path.excludes";
    public static final String OSHI_MAC_FS_PATH_INCLUDES = "com.hypherionmc.sdlink.shaded.oshi.os.mac.filesystem.path.includes";
    public static final String OSHI_MAC_FS_VOLUME_EXCLUDES = "com.hypherionmc.sdlink.shaded.oshi.os.mac.filesystem.volume.excludes";
    public static final String OSHI_MAC_FS_VOLUME_INCLUDES = "com.hypherionmc.sdlink.shaded.oshi.os.mac.filesystem.volume.includes";
    private static final List<PathMatcher> FS_PATH_EXCLUDES = FileSystemUtil.loadAndParseFileSystemConfig("com.hypherionmc.sdlink.shaded.oshi.os.mac.filesystem.path.excludes");
    private static final List<PathMatcher> FS_PATH_INCLUDES = FileSystemUtil.loadAndParseFileSystemConfig("com.hypherionmc.sdlink.shaded.oshi.os.mac.filesystem.path.includes");
    private static final List<PathMatcher> FS_VOLUME_EXCLUDES = FileSystemUtil.loadAndParseFileSystemConfig("com.hypherionmc.sdlink.shaded.oshi.os.mac.filesystem.volume.excludes");
    private static final List<PathMatcher> FS_VOLUME_INCLUDES = FileSystemUtil.loadAndParseFileSystemConfig("com.hypherionmc.sdlink.shaded.oshi.os.mac.filesystem.volume.includes");
