...
extends AbstractInternetProtocolStats {
    ...
    public List<InternetProtocolStats.IPConnection> getConnections() {
        ...
        int numberOfProcesses = com.hypherionmc.sdlink.shaded.oshi.jna.platform.mac.SystemB.INSTANCE.proc_listpids(1, 0, pids, pids.length * SystemB.INT_SIZE) / SystemB.INT_SIZE;
    ...
    private static List<Integer> queryFdList(int pid) {
        ...
        int bufferSize = com.hypherionmc.sdlink.shaded.oshi.jna.platform.mac.SystemB.INSTANCE.proc_pidinfo(pid, 1, 0L, null, 0);
        if (bufferSize > 0) {
            ...
            bufferSize = com.hypherionmc.sdlink.shaded.oshi.jna.platform.mac.SystemB.INSTANCE.proc_pidinfo(pid, 1, 0L, fdArray[0], bufferSize);
    ...
    private static InternetProtocolStats.IPConnection queryIPConnection(int pid, int fd) {
        ...
        int ret = com.hypherionmc.sdlink.shaded.oshi.jna.platform.mac.SystemB.INSTANCE.proc_pidfdinfo(pid, fd, 3, si, si.size());
