...
import com.hypherionmc.sdlink.shaded.oshi.driver.windows.EnumWindows;
import com.hypherionmc.sdlink.shaded.oshi.driver.windows.registry.HkeyUserData;
import com.hypherionmc.sdlink.shaded.oshi.driver.windows.registry.NetSessionData;
...
import com.hypherionmc.sdlink.shaded.oshi.driver.windows.registry.SessionWtsData;
import com.hypherionmc.sdlink.shaded.oshi.driver.windows.registry.ThreadPerformanceData;
import com.hypherionmc.sdlink.shaded.oshi.driver.windows.wmi.Win32OperatingSystem;
import com.hypherionmc.sdlink.shaded.oshi.driver.windows.wmi.Win32Processor;
import com.hypherionmc.sdlink.shaded.oshi.jna.platform.windows.WinNT;
...
import com.hypherionmc.sdlink.shaded.oshi.software.os.windows.WindowsFileSystem;
import com.hypherionmc.sdlink.shaded.oshi.software.os.windows.WindowsInternetProtocolStats;
import com.hypherionmc.sdlink.shaded.oshi.software.os.windows.WindowsNetworkParams;
import com.hypherionmc.sdlink.shaded.oshi.software.os.windows.WindowsOSProcess;
...
extends AbstractOperatingSystem {
    ...
    public static final String OSHI_OS_WINDOWS_PROCSTATE_SUSPENDED = "com.hypherionmc.sdlink.shaded.oshi.os.windows.procstate.suspended";
    private static final boolean USE_PROCSTATE_SUSPENDED = GlobalConfig.get("com.hypherionmc.sdlink.shaded.oshi.os.windows.procstate.suspended", false);
    ...
    private static String querySystemLog() {
        String systemLog = GlobalConfig.get("com.hypherionmc.sdlink.shaded.oshi.os.windows.eventlog", "System");
