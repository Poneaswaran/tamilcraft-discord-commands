...
import com.hypherionmc.sdlink.shaded.oshi.software.os.windows.WindowsOSThread;
...
extends AbstractOSProcess {
    ...
    private static final boolean USE_BATCH_COMMANDLINE = GlobalConfig.get("com.hypherionmc.sdlink.shaded.oshi.os.windows.commandline.batch", false);
