...
import com.hypherionmc.sdlink.shaded.oshi.driver.linux.proc.UserGroupInfo;
...
import com.hypherionmc.sdlink.shaded.oshi.software.os.linux.LinuxOSThread;
...
extends AbstractOSProcess {
    ...
    private String queryCommandLine() {
        return FileUtil.getStringFromFile(String.format(ProcPath.PID_CMDLINE, this.getProcessID()));
    }
