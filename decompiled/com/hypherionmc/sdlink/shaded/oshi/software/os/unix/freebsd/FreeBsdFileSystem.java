 ...
 */
package com.hypherionmc.sdlink.shaded.oshi.software.os.unix.freebsd;
...
import com.hypherionmc.sdlink.shaded.oshi.software.os.linux.LinuxOSFileStore;
...
extends AbstractFileSystem {
    public static final String OSHI_FREEBSD_FS_PATH_EXCLUDES = "com.hypherionmc.sdlink.shaded.oshi.os.freebsd.filesystem.path.excludes";
    public static final String OSHI_FREEBSD_FS_PATH_INCLUDES = "com.hypherionmc.sdlink.shaded.oshi.os.freebsd.filesystem.path.includes";
    public static final String OSHI_FREEBSD_FS_VOLUME_EXCLUDES = "com.hypherionmc.sdlink.shaded.oshi.os.freebsd.filesystem.volume.excludes";
    public static final String OSHI_FREEBSD_FS_VOLUME_INCLUDES = "com.hypherionmc.sdlink.shaded.oshi.os.freebsd.filesystem.volume.includes";
    private static final List<PathMatcher> FS_PATH_EXCLUDES = FileSystemUtil.loadAndParseFileSystemConfig("com.hypherionmc.sdlink.shaded.oshi.os.freebsd.filesystem.path.excludes");
    private static final List<PathMatcher> FS_PATH_INCLUDES = FileSystemUtil.loadAndParseFileSystemConfig("com.hypherionmc.sdlink.shaded.oshi.os.freebsd.filesystem.path.includes");
    private static final List<PathMatcher> FS_VOLUME_EXCLUDES = FileSystemUtil.loadAndParseFileSystemConfig("com.hypherionmc.sdlink.shaded.oshi.os.freebsd.filesystem.volume.excludes");
    private static final List<PathMatcher> FS_VOLUME_INCLUDES = FileSystemUtil.loadAndParseFileSystemConfig("com.hypherionmc.sdlink.shaded.oshi.os.freebsd.filesystem.volume.includes");
