...
implements OperatingSystem {
    public static final String OSHI_OS_UNIX_WHOCOMMAND = "com.hypherionmc.sdlink.shaded.oshi.os.unix.whoCommand";
    protected static final boolean USE_WHO_COMMAND = GlobalConfig.get("com.hypherionmc.sdlink.shaded.oshi.os.unix.whoCommand", false);
