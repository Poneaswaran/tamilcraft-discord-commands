 ...
 */
package com.hypherionmc.sdlink.shaded.oshi.driver.windows.registry;

import com.hypherionmc.sdlink.shaded.oshi.annotation.concurrent.Immutable;
import com.hypherionmc.sdlink.shaded.oshi.annotation.concurrent.ThreadSafe;
import com.hypherionmc.sdlink.shaded.oshi.driver.windows.perfmon.ProcessInformation;
import com.hypherionmc.sdlink.shaded.oshi.driver.windows.registry.HkeyPerformanceDataUtil;
...
public final class ProcessPerformanceData {
    ...
    public static final String WIN_HKEY_PERFDATA = "com.hypherionmc.sdlink.shaded.oshi.os.windows.hkeyperfdata";
    private static final boolean PERFDATA = GlobalConfig.get("com.hypherionmc.sdlink.shaded.oshi.os.windows.hkeyperfdata", true);
