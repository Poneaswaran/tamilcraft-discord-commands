 ...
 */
package com.hypherionmc.sdlink.shaded.oshi.util.platform.windows;

import com.hypherionmc.sdlink.shaded.oshi.annotation.concurrent.ThreadSafe;
import com.hypherionmc.sdlink.shaded.oshi.util.platform.windows.PerfCounterQueryHandler;
import com.hypherionmc.sdlink.shaded.oshi.util.platform.windows.PerfDataUtil;
...
public final class PerfCounterQuery {
    ...
    private static final ConcurrentHashMap<String, String> localizeCache = IS_VISTA_OR_GREATER ? null : new ConcurrentHashMap();
    ...
    public static String localizeIfNeeded(String perfObject) {
        return IS_VISTA_OR_GREATER ? perfObject : localizeCache.computeIfAbsent(perfObject, PerfCounterQuery::localizeUsingPerfIndex);
    }
