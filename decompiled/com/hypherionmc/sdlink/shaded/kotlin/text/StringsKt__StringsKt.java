...
import com.hypherionmc.sdlink.shaded.kotlin.text.DelimitedRangesSequence;
import com.hypherionmc.sdlink.shaded.kotlin.text.MatchResult;
import com.hypherionmc.sdlink.shaded.kotlin.text.Regex;
import com.hypherionmc.sdlink.shaded.kotlin.text.StringsKt;
import com.hypherionmc.sdlink.shaded.kotlin.text.StringsKt__StringsJVMKt;
...
extends StringsKt__StringsJVMKt {
    ...
    public static final boolean contentEqualsIgnoreCaseImpl(@Nullable CharSequence $this$contentEqualsIgnoreCaseImpl, @Nullable CharSequence other) {
        ...
        for (int i = 0; i < n; ++i) {
            if (CharsKt.equals($this$contentEqualsIgnoreCaseImpl.charAt(i), other.charAt(i), true)) continue;
            return false;
        }
        return true;
    }
    ...
    public static final boolean contentEqualsImpl(@Nullable CharSequence $this$contentEqualsImpl, @Nullable CharSequence other) {
        ...
        for (int i = 0; i < n; ++i) {
            if ($this$contentEqualsImpl.charAt(i) == other.charAt(i)) continue;
            return false;
        }
        return true;
    }
