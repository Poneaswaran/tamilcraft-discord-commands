...
import com.hypherionmc.sdlink.shaded.kotlin.jvm.internal.markers.KMutableCollection;
import com.hypherionmc.sdlink.shaded.kotlin.jvm.internal.markers.KMutableIterable;
...
import com.hypherionmc.sdlink.shaded.kotlin.jvm.internal.markers.KMutableSet;
...
public class TypeIntrinsics {
    ...
    public static Iterator asMutableIterator(Object obj) {
        if (obj instanceof KMappedMarker && !(obj instanceof KMutableIterator)) {
            TypeIntrinsics.throwCce(obj, "com.hypherionmc.sdlink.shaded.kotlin.collections.MutableIterator");
        }
    ...
    public static ListIterator asMutableListIterator(Object obj) {
        if (obj instanceof KMappedMarker && !(obj instanceof KMutableListIterator)) {
            TypeIntrinsics.throwCce(obj, "com.hypherionmc.sdlink.shaded.kotlin.collections.MutableListIterator");
        }
    ...
    public static Iterable asMutableIterable(Object obj) {
        if (obj instanceof KMappedMarker && !(obj instanceof KMutableIterable)) {
            TypeIntrinsics.throwCce(obj, "com.hypherionmc.sdlink.shaded.kotlin.collections.MutableIterable");
        }
    ...
    public static Collection asMutableCollection(Object obj) {
        if (obj instanceof KMappedMarker && !(obj instanceof KMutableCollection)) {
            TypeIntrinsics.throwCce(obj, "com.hypherionmc.sdlink.shaded.kotlin.collections.MutableCollection");
        }
    ...
    public static List asMutableList(Object obj) {
        if (obj instanceof KMappedMarker && !(obj instanceof KMutableList)) {
            TypeIntrinsics.throwCce(obj, "com.hypherionmc.sdlink.shaded.kotlin.collections.MutableList");
        }
    ...
    public static Set asMutableSet(Object obj) {
        if (obj instanceof KMappedMarker && !(obj instanceof KMutableSet)) {
            TypeIntrinsics.throwCce(obj, "com.hypherionmc.sdlink.shaded.kotlin.collections.MutableSet");
        }
    ...
    public static Map asMutableMap(Object obj) {
        if (obj instanceof KMappedMarker && !(obj instanceof KMutableMap)) {
            TypeIntrinsics.throwCce(obj, "com.hypherionmc.sdlink.shaded.kotlin.collections.MutableMap");
        }
    ...
    public static Map.Entry asMutableMapEntry(Object obj) {
        if (obj instanceof KMappedMarker && !(obj instanceof KMutableMap.Entry)) {
            TypeIntrinsics.throwCce(obj, "com.hypherionmc.sdlink.shaded.kotlin.collections.MutableMap.MutableEntry");
        }
    ...
    public static Object beforeCheckcastToFunctionOfArity(Object obj, int arity) {
        if (obj != null && !TypeIntrinsics.isFunctionOfArity(obj, arity)) {
            TypeIntrinsics.throwCce(obj, "com.hypherionmc.sdlink.shaded.kotlin.jvm.functions.Function" + arity);
        }
        return obj;
    }
