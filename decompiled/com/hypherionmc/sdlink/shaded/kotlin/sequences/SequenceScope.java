...
import com.hypherionmc.sdlink.shaded.kotlin.coroutines.RestrictsSuspension;
...
public abstract class SequenceScope<T> {
    ...
    @Nullable
    public final Object yieldAll(@NotNull Sequence<? extends T> sequence2, @NotNull Continuation<? super Unit> $completion) {
        Object object = this.yieldAll(sequence2.iterator(), $completion);
        if (object == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            return object;
        }
        return Unit.INSTANCE;
