...
@Metadata(mv={1, 8, 0}, k=2, xi=48, d1={"\u0000+\n\u0000\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002*\u0001\n\u001a\u000e\u0010\f\u001a\u0004\u0018\u00010\r*\u00020\u0005H\u0000\u001a\f\u0010\u000e\u001a\u00020\u0005*\u00020\rH\u0000\"\u0018\u0010\u0000\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001X\u0082\u0004\u00a2\u0006\u0004\n\u0002\u0010\u0003\"\u0016\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00050\u0001X\u0082\u0004\u00a2\u0006\u0004\n\u0002\u0010\u0006\"\u000e\u0010\u0007\u001a\u00020\bX\u0080T\u00a2\u0006\u0002\n\u0000\"\u0010\u0010\t\u001a\u00020\nX\u0082\u0004\u00a2\u0006\u0004\n\u0002\u0010\u000b\u00a8\u0006\u000f"}, d2={"BROWSER_COMPATIBLE_DATE_FORMATS", "", "Ljava/text/DateFormat;", "[Ljava/text/DateFormat;", "BROWSER_COMPATIBLE_DATE_FORMAT_STRINGS", "", "[Ljava/lang/String;", "MAX_DATE", "", "STANDARD_DATE_FORMAT", "com/hypherionmc/sdlink/shaded/okhttp3/internal/http/DatesKt$STANDARD_DATE_FORMAT$1", "Lcom/hypherionmc/sdlink/shaded/okhttp3/internal/http/DatesKt$STANDARD_DATE_FORMAT$1;", "toHttpDateOrNull", "Ljava/util/Date;", "toHttpDateString", "okhttp"})
public final class DatesKt {
    ...
    private static final STANDARD_DATE_FORMAT.1 STANDARD_DATE_FORMAT = new ThreadLocal<DateFormat>(){
        ...
        protected DateFormat initialValue() {
            ...
            SimpleDateFormat $this$initialValue_u24lambda_u240 = simpleDateFormat = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss 'GMT'", Locale.US);
            boolean bl = false;
    ...
    public static final Date toHttpDateOrNull(@NotNull String $this$toHttpDateOrNull) {
        ...
        synchronized (stringArray) {
            boolean bl2 = false;
            int i = 0;
            int n = BROWSER_COMPATIBLE_DATE_FORMAT_STRINGS.length;
            while (true) {
                if (i >= n) {
                ...
                if (format == null) {
                    SimpleDateFormat simpleDateFormat;
                    SimpleDateFormat $this$toHttpDateOrNull_u24lambda_u241_u24lambda_u240 = simpleDateFormat = new SimpleDateFormat(BROWSER_COMPATIBLE_DATE_FORMAT_STRINGS[i], Locale.US);
                    boolean bl3 = false;
