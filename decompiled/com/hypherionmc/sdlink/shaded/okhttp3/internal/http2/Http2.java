...
public final class Http2 {
    ...
    static {
        ...
        while (var0_2 < 256) {
            ...
            Intrinsics.checkNotNullExpressionValue(Integer.toBinaryString(nArray), "toBinaryString(it)");
            i[nArray] = StringsKt.replace$default(Util.format("%8s", objectArray), ' ', '0', false, 4, null);
        }
        BINARY = i;
        Http2.FLAGS[0] = "";
