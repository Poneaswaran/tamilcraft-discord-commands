...
import com.hypherionmc.sdlink.shaded.dv8tion.jda.internal.managers.channel.concrete.ForumChannelManagerImpl;
...
ITopicChannelMixin<ForumChannelImpl> {
    ...
    public ChannelAction<ForumChannel> createCopy(@Nonnull Guild guild) {
        ...
        ChannelAction<ForumChannel> action = guild.createForumChannel(this.name).setNSFW(this.nsfw).setTopic(this.topic).setSlowmode(this.slowmode).setAvailableTags(this.getAvailableTags()).setDefaultLayout(ForumChannel.Layout.fromKey(this.defaultLayout));
