...
import com.hypherionmc.sdlink.shaded.dv8tion.jda.internal.utils.cache.ShardCacheViewImpl;
import com.hypherionmc.sdlink.shaded.dv8tion.jda.internal.utils.cache.UnifiedCacheViewImpl;
...
extends Iterable<T> {
    ...
    @Nonnull
    public @Unmodifiable Set<T> asSet();
    ...
    @Nonnull
    public @Unmodifiable List<T> getElementsByName(@Nonnull String var1, boolean var2);

    @Nonnull
    default public @Unmodifiable List<T> getElementsByName(@Nonnull String name) {
