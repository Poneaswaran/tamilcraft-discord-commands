...
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.ArrayUtils;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.BoundedCollection;
...
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.EnumerationUtils;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.Equator;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.IterableUtils;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.IteratorUtils;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.ListUtils;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.Predicate;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.PredicateUtils;
...
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.collection.PredicatedCollection;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.collection.SynchronizedCollection;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.collection.TransformedCollection;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.collection.UnmodifiableBoundedCollection;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.collection.UnmodifiableCollection;
...
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.iterators.PermutationIterator;
...
public class CollectionUtils {
    ...
    @Deprecated
    public static <T, C extends Closure<? super T>> C forAllDo(Iterator<T> iterator2, C closure) {
        if (closure != null) {
            IteratorUtils.forEach(iterator2, closure);
        }
        return closure;
    }
    ...
    @Deprecated
    public static <T, C extends Closure<? super T>> T forAllButLastDo(Iterator<T> iterator2, C closure) {
        return closure != null ? (T)IteratorUtils.forEachButLast(iterator2, closure) : null;
    }
    ...
    public static <C> boolean addAll(Collection<C> collection, Iterator<? extends C> iterator2) {
        boolean changed = false;
        while (iterator2.hasNext()) {
            changed |= collection.add(iterator2.next());
        }
        return changed;
    }
    ...
    @Deprecated
    public static <T> T get(Iterator<T> iterator2, int index) {
    ...
    public static <O> List<O> collate(Iterable<? extends O> a, Iterable<? extends O> b, Comparator<? super O> c, boolean includeDuplicates) {
        ...
        CollatingIterator<O> iterator2 = new CollatingIterator<O>(c, a.iterator(), b.iterator());
        if (includeDuplicates) {
            return IteratorUtils.toList(iterator2, totalSize);
        }
