...
implements Factory<T> {
    ...
    public static <T> Factory<T> instantiateFactory(Class<T> classToInstantiate, Class<?>[] paramTypes, Object[] args2) {
        ...
        return new InstantiateFactory<T>(classToInstantiate, paramTypes, args2);
    }
    ...
    public InstantiateFactory(Class<T> classToInstantiate, Class<?>[] paramTypes, Object[] args2) {
        this.iClassToInstantiate = classToInstantiate;
        this.iParamTypes = (Class[])paramTypes.clone();
        this.iArgs = (Object[])args2.clone();
        this.findConstructor();
    }
