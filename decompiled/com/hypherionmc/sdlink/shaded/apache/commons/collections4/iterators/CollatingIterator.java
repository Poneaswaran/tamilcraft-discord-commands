...
implements Iterator<E> {
    ...
    public CollatingIterator(Comparator<? super E> comp, Iterator<? extends E>[] iterators) {
        ...
        for (Iterator<? extends E> iterator2 : iterators) {
    ...
    public CollatingIterator(Comparator<? super E> comp, Collection<Iterator<? extends E>> iterators) {
        ...
        for (Iterator<E> iterator2 : iterators) {
            this.addIterator(iterator2);
        }
    }

    public void addIterator(Iterator<? extends E> iterator2) {
    ...
    public void setIterator(int index, Iterator<? extends E> iterator2) {
        this.checkNotStarted();
        if (iterator2 == null) {
            throw new NullPointerException("Iterator must not be null");
        }
        this.iterators.set(index, iterator2);
    }
    ...
    private boolean anyHasNext(List<Iterator<? extends E>> iters) {
        for (Iterator<E> iterator2 : iters) {
