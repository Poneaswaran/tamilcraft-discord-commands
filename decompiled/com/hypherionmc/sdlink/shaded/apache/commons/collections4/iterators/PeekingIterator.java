...
implements Iterator<E> {
    ...
    public static <E> PeekingIterator<E> peekingIterator(Iterator<? extends E> iterator2) {
        if (iterator2 == null) {
            throw new NullPointerException("Iterator must not be null");
        }
        if (iterator2 instanceof PeekingIterator) {
            PeekingIterator it = (PeekingIterator)iterator2;
            return it;
        }
        return new PeekingIterator<E>(iterator2);
    }

    public PeekingIterator(Iterator<? extends E> iterator2) {
