 ...
 */
package com.hypherionmc.sdlink.shaded.apache.commons.collections4.multiset;

import com.hypherionmc.sdlink.shaded.apache.commons.collections4.MultiSet;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.iterators.AbstractIteratorDecorator;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.multiset.AbstractMultiSet;
...
extends AbstractMultiSet<E> {
    ...
    implements Iterator<MultiSet.Entry<E>> {
        ...
        protected EntrySetIterator(Iterator<Map.Entry<E, MutableInteger>> iterator2, AbstractMapMultiSet<E> parent) {
            this.decorated = iterator2;
            this.parent = parent;
        }
    ...
    extends AbstractIteratorDecorator<E> {
        ...
        protected UniqueSetIterator(Iterator<E> iterator2, AbstractMapMultiSet<E> parent) {
            super(iterator2);
            this.parent = parent;
        }
