...
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.FactoryUtils;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.FluentIterable;
...
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.iterators.LazyIteratorChain;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.iterators.ReverseListIterator;
import com.hypherionmc.sdlink.shaded.apache.commons.collections4.iterators.UniqueFilterIterator;
...
public class IterableUtils {
    ...
    public static <O> List<List<O>> partition(Iterable<? extends O> iterable, Predicate<? super O> predicate) {
        ...
        Factory<ArrayList> factory2 = FactoryUtils.instantiateFactory(ArrayList.class);
        Predicate[] predicates = new Predicate[]{predicate};
        return IterableUtils.partition(iterable, factory2, predicates);
    }
