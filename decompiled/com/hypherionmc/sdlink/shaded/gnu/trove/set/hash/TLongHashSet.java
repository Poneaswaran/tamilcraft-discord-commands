 ...
 */
package com.hypherionmc.sdlink.shaded.gnu.trove.set.hash;
...
import com.hypherionmc.sdlink.shaded.gnu.trove.impl.hash.TLongHash;
...
Externalizable {
    ...
    public TLongHashSet(TLongCollection collection) {
        ...
        if (collection instanceof TLongHashSet) {
            ...
            this.setUp(TLongHashSet.saturatedCast(TLongHashSet.fastCeil(10.0 / (double)this._loadFactor)));
        }
        this.addAll(collection);
    }
    ...
    @Override
    public long[] toArray() {
        return this.toArray(new long[this._size]);
    }
