...
import com.hypherionmc.sdlink.shaded.gnu.trove.iterator.hash.TObjectHashIterator;
...
Externalizable {
    ...
    public TObjectIntHashMap(TObjectIntMap<? extends K> map) {
        ...
        if (map instanceof TObjectIntHashMap) {
            ...
            this.setUp(TObjectIntHashMap.saturatedCast(TObjectIntHashMap.fastCeil(10.0 / (double)this._loadFactor)));
        }
        this.putAll(map);
    }
