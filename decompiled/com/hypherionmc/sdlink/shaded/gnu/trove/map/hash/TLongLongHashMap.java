...
import com.hypherionmc.sdlink.shaded.gnu.trove.impl.hash.TLongLongHash;
...
import com.hypherionmc.sdlink.shaded.gnu.trove.iterator.TLongLongIterator;
import com.hypherionmc.sdlink.shaded.gnu.trove.map.TLongLongMap;
import com.hypherionmc.sdlink.shaded.gnu.trove.procedure.TLongLongProcedure;
...
Externalizable {
    ...
    public TLongLongHashMap(TLongLongMap map) {
        ...
        if (map instanceof TLongLongHashMap) {
            ...
            this.setUp(TLongLongHashMap.saturatedCast(TLongLongHashMap.fastCeil(10.0 / (double)this._loadFactor)));
        }
        this.putAll(map);
    }
