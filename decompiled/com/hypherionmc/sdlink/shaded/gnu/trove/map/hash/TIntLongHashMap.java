...
import com.hypherionmc.sdlink.shaded.gnu.trove.impl.hash.TIntLongHash;
...
Externalizable {
    ...
    public TIntLongHashMap(TIntLongMap map) {
        ...
        if (map instanceof TIntLongHashMap) {
            ...
            this.setUp(TIntLongHashMap.saturatedCast(TIntLongHashMap.fastCeil(10.0 / (double)this._loadFactor)));
        }
        this.putAll(map);
    }
