...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.UnresolvedId;
...
extends JsonMappingException {
    ...
    public String getMessage() {
        ...
        Iterator<UnresolvedId> iterator2 = this._unresolvedIds.iterator();
        while (iterator2.hasNext()) {
            UnresolvedId unresolvedId = iterator2.next();
