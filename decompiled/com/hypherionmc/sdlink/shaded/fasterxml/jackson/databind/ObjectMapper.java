...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.annotation.JsonAutoDetect;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.annotation.PropertyAccessor;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.Base64Variant;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.Base64Variants;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.FormatSchema;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.JsonEncoding;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.PrettyPrinter;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.StreamReadFeature;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.StreamWriteFeature;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.TreeNode;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.exc.StreamWriteException;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.io.CharacterEscapes;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.type.ResolvedType;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.type.TypeReference;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.DatabindException;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.InjectableValues;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.MappingIterator;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.MappingJsonFactory;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.Module;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ObjectReader;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ObjectWriter;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.BaseSettings;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.CacheProvider;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.CoercionConfigs;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.ConfigOverrides;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.ConstructorDetector;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.ContextAttributes;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.DatatypeFeature;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.DatatypeFeatures;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.DefaultCacheProvider;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.MutableCoercionConfig;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.MutableConfigOverride;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.PackageVersion;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.BeanDeserializerFactory;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.BeanDeserializerModifier;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.DefaultDeserializationContext;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.DeserializationProblemHandler;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.introspect.AccessorNamingStrategy;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.introspect.BasicClassIntrospector;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.introspect.ClassIntrospector;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.introspect.DefaultAccessorNamingStrategy;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.introspect.JacksonAnnotationIntrospector;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.introspect.SimpleMixInResolver;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.jsonschema.JsonSchema;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.jsontype.SubtypeResolver;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.jsontype.impl.StdSubtypeResolver;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.jsontype.impl.StdTypeResolverBuilder;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.node.ArrayNode;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.node.JsonNodeFactory;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.node.NullNode;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.node.ObjectNode;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.node.POJONode;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.node.TreeTraversingParser;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.BeanSerializerFactory;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.BeanSerializerModifier;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.DefaultSerializerProvider;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.FilterProvider;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.SerializerFactory;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.type.TypeModifier;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.util.ClassUtil;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.util.RootNameLookup;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.util.StdDateFormat;
...
Serializable {
    ...
    protected ObjectMapper(ObjectMapper src, JsonFactory factory2) {
        this._jsonFactory = factory2 != null ? factory2 : src._jsonFactory.copy();
    ...
    public ObjectMapper copyWith(JsonFactory factory2) {
        this._checkInvalidCopy(ObjectMapper.class);
        return new ObjectMapper(this, factory2);
    }
    ...
    public JsonNode readTree(URL source2) throws IOException {
        this._assertNotNull("source", source2);
        return this._readTreeAndClose(this._jsonFactory.createParser(source2));
    }
