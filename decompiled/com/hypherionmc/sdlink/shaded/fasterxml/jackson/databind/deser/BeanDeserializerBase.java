...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.JacksonException;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.BeanDeserializerBuilder;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.ResolvableDeserializer;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.SettableAnyProperty;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.SettableBeanProperty;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.UnresolvedForwardReference;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.ValueInstantiator;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.BeanPropertyMap;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.ExternalTypeHandler;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.InnerClassProperty;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.ManagedReferenceProperty;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.MergingSettableBeanProperty;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.ObjectIdReader;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.ObjectIdReferenceProperty;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.ObjectIdValueProperty;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.PropertyBasedCreator;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.PropertyBasedObjectIdGenerator;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.ReadableObjectId;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.SetterlessProperty;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.TypeWrappedDeserializer;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.UnwrappedPropertyHandler;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.impl.ValueInjector;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.std.StdDelegatingDeserializer;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.std.StdDeserializer;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.exc.IgnoredPropertyException;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.util.IgnorePropertiesUtil;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.util.NameTransformer;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.util.NativeImageUtil;
...
Serializable {
    ...
    protected <T> T wrapInstantiationProblem(Throwable t, DeserializationContext ctxt) throws IOException {
        ...
        return (T)ctxt.handleInstantiationProblem(this._beanType.getRawClass(), null, t);
    }
}
