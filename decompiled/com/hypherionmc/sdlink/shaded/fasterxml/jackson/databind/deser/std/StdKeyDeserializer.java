...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.EnumFeature;
...
implements Serializable {
    ...
    extends StdKeyDeserializer {
        ...
        protected EnumKD(EnumResolver er, AnnotatedMethod factory2) {
        ...
        protected EnumKD(EnumResolver er, AnnotatedMethod factory2, EnumResolver byEnumNamingResolver, EnumResolver byToStringResolver, EnumResolver byIndexResolver) {
            super(-1, er.getEnumClass());
            this._byNameResolver = er;
            this._factory = factory2;
            this._enumDefaultValue = er.getDefaultValue();
