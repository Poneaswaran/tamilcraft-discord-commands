...
public class BeanUtil {
    ...
    public static String checkUnsupportedType(JavaType type) {
        ...
        if (BeanUtil.isJava8TimeClass(className)) {
            ...
            moduleName = "com.hypherionmc.sdlink.shaded.fasterxml.jackson.datatype:jackson-datatype-jsr310";
        } else if (BeanUtil.isJodaTimeClass(className)) {
            typeName = "Joda date/time";
            moduleName = "com.hypherionmc.sdlink.shaded.fasterxml.jackson.datatype:jackson-datatype-joda";
        } else if (BeanUtil.isJava8OptionalClass(className)) {
            typeName = "Java 8 optional";
            moduleName = "com.hypherionmc.sdlink.shaded.fasterxml.jackson.datatype:jackson-datatype-jdk8";
        } else {
            return null;
        }
