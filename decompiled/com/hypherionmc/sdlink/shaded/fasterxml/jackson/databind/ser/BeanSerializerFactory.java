...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.AnyGetterWriter;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.BasicSerializerFactory;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.PropertyBuilder;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.ResolvableSerializer;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.impl.FilteredBeanPropertyWriter;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.impl.ObjectIdWriter;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.impl.PropertyBasedObjectIdGenerator;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.impl.UnsupportedTypeSerializer;
    ...
    protected JsonSerializer<?> _createSerializer2(SerializerProvider prov, JavaType type, BeanDescription beanDesc, boolean staticTyping) throws JsonMappingException {
        ...
        if (type.isContainerType()) {
            ...
            if (type.isReferenceType()) {
                ...
                while (iterator2.hasNext() && (ser = (serializers = iterator2.next()).findSerializer(config, type, beanDesc)) == null) {
                }
            }
            if (ser == null) {
