...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.type.ClassStack;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.type.IterationType;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.type.PlaceholderForType;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.type.ReferenceType;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.type.ResolvedRecursiveType;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.type.SimpleType;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.type.TypeParser;
...
lbl22:
    ...
    public JavaType findFirstTypeParameter(JavaType type, Class<?> expType) {
        JavaType t;
        JavaType match = type.findSuperType(expType);
        if (match != null && (t = match.getBindings().getBoundTypeOrNull(0)) != null) {
            return t;
        }
    ...
    protected JavaType _fromParamType(ClassStack context, ParameterizedType ptype, TypeBindings parentBindings) {
        ...
        int n = paramCount = args2 == null ? 0 : args2.length;
        if (paramCount == 0) {
            newBindings = EMPTY_BINDINGS;
        } else {
            JavaType[] pt = new JavaType[paramCount];
            for (int i = 0; i < paramCount; ++i) {
                pt[i] = this._fromAny(context, args2[i], parentBindings);
            }
