...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.SerializerCache;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.SerializerFactory;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.impl.FailingSerializer;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.impl.ReadOnlyClassToSerializerMap;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.impl.TypeWrappedSerializer;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.impl.UnknownSerializer;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.impl.WritableObjectId;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.std.NullSerializer;
...
extends DatabindContext {
    ...
    public void reportMappingProblem(String message, Object ... args2) throws JsonMappingException {
        throw this.mappingException(message, args2);
    }
