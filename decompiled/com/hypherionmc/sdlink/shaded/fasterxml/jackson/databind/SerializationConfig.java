...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.json.JsonWriteFeature;
...
implements Serializable {
    ...
    public final boolean isEnabled(JsonGenerator.Feature f, JsonFactory factory2) {
        int mask = f.getMask();
