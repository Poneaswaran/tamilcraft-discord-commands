...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.introspect.MemberKey;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.introspect.MethodGenericTypeResolver;
...
extends CollectorBase {
    ...
    private List<AnnotatedMethod> _findPotentialFactories(TypeFactory typeFactory, JavaType type, Class<?> primaryMixIn) {
        ...
        for (int i = 0; i < factoryCount; ++i) {
            AnnotatedMethod factory2 = (AnnotatedMethod)result.get(i);
