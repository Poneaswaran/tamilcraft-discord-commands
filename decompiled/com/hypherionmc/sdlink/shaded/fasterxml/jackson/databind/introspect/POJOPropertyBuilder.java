...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.introspect.AnnotationMap;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.introspect.POJOPropertiesCollector;
            ...
            block10: {
                ...
                block8: {
                    ...
                    block9: {
                        ...
                        if (fieldClass == (nextClass = nextField.getDeclaringClass())) break block8;
                        if (!fieldClass.isAssignableFrom(nextClass)) break block9;
                        field = nextField;
                        break block10;
                    }
                    if (nextClass.isAssignableFrom(fieldClass)) break block10;
                }
                if ((currStatic = field.isStatic()) != (nextStatic = nextField.isStatic())) {
                    if (currStatic) {
                        field = nextField;
                    }
                } else {
