 ...
 */
package com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ext;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ext.Java7Handlers;
...
implements Serializable {
    ...
    private static final String SERIALIZERS_FOR_JAVAX_XML = "com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ext.CoreXMLSerializers";
    private static final String DESERIALIZERS_FOR_JAVAX_XML = "com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ext.CoreXMLDeserializers";
    private static final String SERIALIZER_FOR_DOM_NODE = "com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ext.DOMSerializer";
    private static final String DESERIALIZER_FOR_DOM_DOCUMENT = "com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ext.DOMDeserializer$DocumentDeserializer";
    private static final String DESERIALIZER_FOR_DOM_NODE = "com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ext.DOMDeserializer$NodeDeserializer";
    ...
    protected OptionalHandlerFactory() {
        this._sqlDeserializers.put(CLS_NAME_JAVA_SQL_DATE, "com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.std.DateDeserializers$SqlDateDeserializer");
        this._sqlDeserializers.put(CLS_NAME_JAVA_SQL_TIMESTAMP, "com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.deser.std.DateDeserializers$TimestampDeserializer");
        ...
        this._sqlSerializers.put(CLS_NAME_JAVA_SQL_DATE, "com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.std.SqlDateSerializer");
        this._sqlSerializers.put(CLS_NAME_JAVA_SQL_TIME, "com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ser.std.SqlTimeSerializer");
        this._sqlSerializers.put(CLS_NAME_JAVA_SQL_BLOB, "com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ext.SqlBlobSerializer");
        this._sqlSerializers.put(CLS_NAME_JAVA_SQL_SERIALBLOB, "com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.ext.SqlBlobSerializer");
    }
