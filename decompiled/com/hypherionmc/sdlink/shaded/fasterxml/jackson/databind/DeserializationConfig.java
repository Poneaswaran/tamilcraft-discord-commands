...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.json.JsonReadFeature;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.MapperConfigBase;
...
implements Serializable {
    ...
    public final boolean isEnabled(JsonParser.Feature f, JsonFactory factory2) {
        int mask = f.getMask();
        if ((this._parserFeaturesToChange & mask) != 0) {
            return (this._parserFeatures & f.getMask()) != 0;
        }
        return factory2.isEnabled(f);
    }
