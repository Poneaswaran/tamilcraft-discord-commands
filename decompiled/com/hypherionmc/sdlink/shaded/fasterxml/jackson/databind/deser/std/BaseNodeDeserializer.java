...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.cfg.JsonNodeFeature;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.databind.node.ContainerNode;
        ...
        if (ctxt.isEnabled(DeserializationFeature.USE_BIG_DECIMAL_FOR_FLOATS)) {
            if (p.isNaN()) {
                if (ctxt.isEnabled(JsonNodeFeature.FAIL_ON_NAN_TO_BIG_DECIMAL_COERCION)) {
                    return (JsonNode)ctxt.handleWeirdNumberValue(this.handledType(), p.getDoubleValue(), "Cannot convert NaN into BigDecimal", new Object[0]);
                }
