...
implements Serializable {
    ...
    protected DefaultDeserializationContext(DefaultDeserializationContext src, DeserializerFactory factory2) {
        super((DeserializationContext)src, factory2);
    }
    ...
    public void checkUnresolvedObjectId() throws UnresolvedForwardReference {
        ...
        for (Map.Entry<ObjectIdGenerator.IdKey, ReadableObjectId> entry : this._objectIds.entrySet()) {
            ...
            Iterator<ReadableObjectId.Referring> iterator2 = roid.referringProperties();
    ...
    extends DefaultDeserializationContext {
        ...
        private Impl(Impl src, DeserializerFactory factory2) {
            super((DefaultDeserializationContext)src, factory2);
        }
        ...
        @Override
        public DefaultDeserializationContext with(DeserializerFactory factory2) {
            return new Impl(this, factory2);
        }
