...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.json.JsonParserBase;
...
extends JsonParserBase {
    ...
    protected final void _matchTrue() throws IOException {
        ...
        byte[] buf;
        int ptr = this._inputPtr;
        if (ptr + 3 < this._inputEnd && (buf = this._inputBuffer)[ptr++] == 114 && buf[ptr++] == 117 && buf[ptr++] == 101 && ((ch = buf[ptr] & 0xFF) < 48 || (ch | 0x20) == 125)) {
            this._inputPtr = ptr;
            return;
        }
    ...
    protected final void _matchFalse() throws IOException {
        ...
        byte[] buf;
        int ptr = this._inputPtr;
        if (ptr + 4 < this._inputEnd && (buf = this._inputBuffer)[ptr++] == 97 && buf[ptr++] == 108 && buf[ptr++] == 115 && buf[ptr++] == 101 && ((ch = buf[ptr] & 0xFF) < 48 || (ch | 0x20) == 125)) {
            this._inputPtr = ptr;
            return;
        }
    ...
    protected final void _matchNull() throws IOException {
        ...
        byte[] buf;
        int ptr = this._inputPtr;
        if (ptr + 3 < this._inputEnd && (buf = this._inputBuffer)[ptr++] == 117 && buf[ptr++] == 108 && buf[ptr++] == 108 && ((ch = buf[ptr] & 0xFF) < 48 || (ch | 0x20) == 125)) {
            this._inputPtr = ptr;
            return;
        }
