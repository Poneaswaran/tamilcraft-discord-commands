 ...
 */
package com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.json.async;
...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.json.async.NonBlockingJsonParserBase;
...
extends NonBlockingJsonParserBase {
    ...
    protected JsonToken _startFalseToken() throws IOException {
        int ch;
        int ptr = this._inputPtr;
        if (ptr + 4 < this._inputEnd && this.getByteFromBuffer(ptr++) == 97 && this.getByteFromBuffer(ptr++) == 108 && this.getByteFromBuffer(ptr++) == 115 && this.getByteFromBuffer(ptr++) == 101 && ((ch = this.getByteFromBuffer(ptr) & 0xFF) < 48 || (ch | 0x20) == 125)) {
            this._inputPtr = ptr;
    ...
    protected JsonToken _startTrueToken() throws IOException {
        int ch;
        int ptr = this._inputPtr;
        if (ptr + 3 < this._inputEnd && this.getByteFromBuffer(ptr++) == 114 && this.getByteFromBuffer(ptr++) == 117 && this.getByteFromBuffer(ptr++) == 101 && ((ch = this.getByteFromBuffer(ptr) & 0xFF) < 48 || (ch | 0x20) == 125)) {
            this._inputPtr = ptr;
    ...
    protected JsonToken _startNullToken() throws IOException {
        int ch;
        int ptr = this._inputPtr;
        if (ptr + 3 < this._inputEnd && this.getByteFromBuffer(ptr++) == 117 && this.getByteFromBuffer(ptr++) == 108 && this.getByteFromBuffer(ptr++) == 108 && ((ch = this.getByteFromBuffer(ptr) & 0xFF) < 48 || (ch | 0x20) == 125)) {
            this._inputPtr = ptr;
            return this._valueComplete(JsonToken.VALUE_NULL);
        }
        this._minorState = 16;
