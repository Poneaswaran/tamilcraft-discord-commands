...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.io.schubfach.DoubleToDecimal;
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.io.schubfach.FloatToDecimal;
...
public final class NumberOutput {
    ...
    public static int outputInt(int v, char[] b, int off) {
        ...
        if (v < MILLION) {
            ...
            int thousands = NumberOutput.divBy1000(v);
        ...
        int newValue = NumberOutput.divBy1000(v);
        int ones = v - newValue * 1000;
        v = newValue;
        newValue = NumberOutput.divBy1000(newValue);
    ...
    private static int _outputUptoBillion(int v, char[] b, int off) {
        ...
        int thousands = NumberOutput.divBy1000(v);
        int ones = v - thousands * 1000;
        int millions = NumberOutput.divBy1000(thousands);
