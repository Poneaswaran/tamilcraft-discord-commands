...
import com.hypherionmc.sdlink.shaded.fasterxml.jackson.core.io.doubleparser.AbstractFloatValueParser;
...
extends AbstractFloatValueParser {
    ...
    public final long parseFloatingPointLiteral(CharSequence str, int offset, int length) {
        ...
        boolean isNegative;
        int endIndex = AbstractJavaFloatingPointBitsFromCharSequence.checkBounds(str.length(), offset, length);
        ...
        if (hasLeadingZero && ((ch = AbstractJavaFloatingPointBitsFromCharSequence.charAt(str, ++index, endIndex)) | 0x20) == 120) {
