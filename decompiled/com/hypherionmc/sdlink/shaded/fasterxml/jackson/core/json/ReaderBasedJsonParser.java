...
extends JsonParserBase {
    ...
    public final JsonToken nextToken() throws IOException {
        ...
        if (this._parsingContext.expectComma()) {
            i = this._skipComma(i);
            if ((this._features & FEAT_MASK_TRAILING_COMMA) != 0 && (i | 0x20) == 125) {
                this._closeScope(i);
                return this._currToken;
            }
        }
    ...
    private final JsonToken _parseNumber2(boolean neg, int startPtr) throws IOException {
        ...
        int intLen = 0;
        char c2 = c = this._inputPtr < this._inputEnd ? this._inputBuffer[this._inputPtr++] : this.getNextChar("No digit following sign", JsonToken.VALUE_NUMBER_INT);
        if (c == '0') {
