...
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.Token;
...
class HandshakeBuilder {
    ...
    public HandshakeBuilder(HandshakeBuilder source2) {
        this.mSecure = source2.mSecure;
        this.mUserInfo = source2.mUserInfo;
        this.mHost = source2.mHost;
        this.mPath = source2.mPath;
        this.mUri = source2.mUri;
        this.mKey = source2.mKey;
        this.mProtocols = HandshakeBuilder.copyProtocols(source2.mProtocols);
        this.mExtensions = HandshakeBuilder.copyExtensions(source2.mExtensions);
        this.mHeaders = HandshakeBuilder.copyHeaders(source2.mHeaders);
    }
