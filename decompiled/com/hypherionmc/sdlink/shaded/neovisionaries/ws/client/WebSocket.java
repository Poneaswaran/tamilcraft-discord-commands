...
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.Base64;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.ConnectThread;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.Connectable;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.CounterPayloadGenerator;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.FinishThread;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.HandshakeBuilder;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.HandshakeReader;
...
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.PerMessageCompressionExtension;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.PingSender;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.PongSender;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.ReadingThread;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.SocketConnector;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.StateManager;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.ThreadType;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.WebSocketError;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.WebSocketException;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.WebSocketExtension;
...
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.WebSocketInputStream;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.WebSocketListener;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.WebSocketOutputStream;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.WebSocketState;
import com.hypherionmc.sdlink.shaded.neovisionaries.ws.client.WritingThread;
...
public class WebSocket {
    ...
    WebSocket(WebSocketFactory factory2, boolean secure, String userInfo, String host, String path, SocketConnector connector) {
     ...
     */
    public WebSocket recreate(int timeout2) throws IOException {
        List<WebSocketListener> listeners;
        if (timeout2 < 0) {
            throw new IllegalArgumentException("The given timeout value is negative.");
        }
        WebSocket instance = this.mWebSocketFactory.createSocket(this.getURI(), timeout2);
    ...
    private void writeHandshake(WebSocketOutputStream output, String key) throws WebSocketException {
        ...
        String handshake2 = HandshakeBuilder.build(requestLine, headers);
        this.mListenerManager.callOnSendingHandshake(requestLine, headers);
        try {
            output.write(handshake2);
            output.flush();
        }
        catch (IOException e) {
