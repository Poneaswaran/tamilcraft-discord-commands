...
extends SDLinkSlashCommand {
    public HidePlayerCommand() {
        ...
        this.options = new ArrayList<OptionData>(){
            {
                this.add(new OptionData(OptionType.USER, "user", "The user to make invisible").setRequired(true));
                this.add(new OptionData(OptionType.BOOLEAN, "minecraft", "Hide the user in minecraft if they have a linked account").setRequired(false));
            }
        };
    }
